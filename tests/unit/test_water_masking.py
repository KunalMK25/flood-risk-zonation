...
class TestWaterMaskingHardOverride:
    ...
    def test_elevation_mask_fires_for_low_elevation(self):
        """Cells with elevation ≤ 1 m get Water class even with no OSM water bodies."""
        ...
        # Use elevation_source="real" to enable the elevation mask
        result = _pipeline()._apply_water_mask_and_proximity_boost(
            grid, empty_wb, _config(), elevation_source="real"
        )
