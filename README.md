...
> **Note on `.kiro/specs/`:** This directory contains AI-assisted specification files generated by [Kiro](https://kiro.dev/) (Amazon's spec-driven IDE). They describe the intended behaviour of the system in structured markdown and are checked in for reference — they are not required to run the app.
